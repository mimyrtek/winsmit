...
namespace WinSmit
{
    ...
    class sm_cmd_opt 
    {
        private int _key;
        //****************************
        [DescriptionAttribute("Internal, do not change this value"),CategoryAttribute("Internal Setttings"), ReadOnlyAttribute(true)]
        public int key
        {
            get
            {
        ...
        //******************************
        [DescriptionAttribute("The position of this item in relation to other items on the dialog; sm_cmd_opt objects in a dialog are sorted on this string field. The value of id_seq_num is a string with a maximum length of 16 characters. When this object is part of a dialog screen, the string \"0\" is not a valid value for this field. When this object is part of a selector screen, the id_seq_num descriptor must be set to 0."),
        CategoryAttribute("ID and Position Setttings")]
...
"\"m\" - Yes; a user can select multiple items from the list. When the command is built, the option prefix is inserted before each selected item."),
        ...
        //******************************
        [DescriptionAttribute("Specifies a Message Facility message set number and message ID number with a comma as the separator or a numeric string equal to a SMIT identifier tag. "),
       CategoryAttribute("Help Setttings")]
        ...
        //******************************
        [DescriptionAttribute("The file name sent as a parameter to the man command for retrieval of help text, or the file name of a file containing help text. The value of help_msg_loc is a string with a maximum length of 1024 characters."),
       CategoryAttribute("Help Setttings")]
        ...
        //******************************
        [DescriptionAttribute("The fully qualified path name of a library that SMIT reads for the file names associated with the correct book."),
       CategoryAttribute("Help Setttings")]
        ...
        //******************************
        [DescriptionAttribute("Contains the string with the value of the name file contained in the file library indicated by help_msg_base."),
       CategoryAttribute("Help Setttings")]
