...
const string s_help_msg_book ="Contains the string with the value of the name file contained in the file library indicated by help_msg_base. ";
        ...
        private int _key;
        //****************************
        [DescriptionAttribute(), CategoryAttribute("Internal Setttings"), ReadOnlyAttribute(true)]
        public int key
        {
            get
            {
        ...
        //****************************
        [DescriptionAttribute(s_help_msg_id), CategoryAttribute("Help Setttings")]
        ...
        //****************************
        [DescriptionAttribute(s_help_msg_loc), CategoryAttribute("Help Setttings")]
        ...
        //****************************
        [DescriptionAttribute(s_help_msg_base), CategoryAttribute("Help Setttings")]
        ...
        //****************************
        [DescriptionAttribute(s_help_msg_book), CategoryAttribute("Help Setttings")]
